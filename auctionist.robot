...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'auctionist_Viewer'  Run Keywords
  ...  Login  ${username}
...
Завантажити ілюстрацію
  ...
  auctionist.Завантажити документ   ${username}  ${filepath}  ${tender_uaid}  True
...
Задати запитання на тендер
  ...
  auctionist.Задати питання  ${username}  ${tender_uaid}  ${question}

Задати запитання на предмет
  [Arguments]  ${username}  ${tender_uaid}  ${item_id}  ${question}
  auctionist.Задати питання  ${username}  ${tender_uaid}  ${question}  ${item_id}
...
Отримати документ
  ...
  auctionist_download_file   ${url}  ${file_name}  ${OUTPUT_DIR}
  [return]  ${file_name}
...
Отримати інформацію із документа по індексу
  ...
  ${doc_value}=  convert_string_from_dict_auctionist  ${doc_value}
  [return]  ${doc_value}
...
Подати цінову пропозицію
  ...
  Switch Browser  ${my_alias}
  auctionist.Пошук тендера по ідентифікатору   ${username}  ${tender_uaid}
  Run Keyword And Ignore Error  auctionist.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
...
Змінити цінову пропозицію
  ...
  ${file_path}=  get_upload_file_path
  auctionist.Пошук тендера по ідентифікатору   ${username}  ${tender_uaid}
  auctionist.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
...
#  ...  auctionist.Отримати інформацію із пропозиції  ${username}  ${tender_uaid}  ${EMPTY}
#  ...  AND  auctionist.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
...
Завантажити фінансову ліцензію
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  auctionist.Завантажити документ в ставку  ${username}  ${filepath}  ${tender_uaid}

Змінити документ в ставці
  [Arguments]  ${username}  ${tender_uaid}  ${path}  ${docid}
  auctionist.Завантажити документ в ставку  ${username}  ${path}  ${tender_uaid}
...
Conv And Select From List By Value
  ...
  ${smth_to_select}=  convert_string_from_dict_auctionist  ${smth_to_select}
  Select From List By Value  ${elem_locator}  ${smth_to_select}

Input Date
  [Arguments]  ${elem_locator}  ${date}
  ${date}=  convert_datetime_to_auctionist_format  ${date}
